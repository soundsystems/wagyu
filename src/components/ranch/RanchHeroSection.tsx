    ...
    <section className="relative flex h-[70vh] items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-8 text-center">
        ...
        >
          ...
          <h1 className="mt-6 mb-6 text-4xl leading-tight tracking-wide md:mt-2 md:text-6xl">
            Two Generations of <br />
            <span className="text-luxury-gold">Ozark Heritage</span>
          </h1>
          <p className="mb-8 max-w-5xl text-pretty font-sans text-sm text-white/90 leading-relaxed md:text-lg lg:text-xl">
